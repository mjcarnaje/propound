          ...
          <Stack spacing={12}>
            <Box>
              ...
              <Text fontSize="lg" textAlign="justify" lineHeight="1.7">
                Propound is a game-based learning web-application, a research
                product of John Paul Carnaje and Kim Kim Joy Zagado that aims to
                assist learning through game-based activities. Its main
                ...
                students to learn. The most frequently mentioned feature of
                games is their ability to motivate learners. The premise is that
                through a variety of motivational game features, games for
                enjoyment have been found to drive learners to stay engaged for
                lengthy periods of time (Plass, et al., 2015).
                <br /> Through game-based activities, propound yearns to provide
                a fun learning environment as research shows that having fun
                while learning provides unique cognitive resources, correlates
                reward and pleasure with information, strengthens and broadens
                memory networks, and switches between two basic brain modes —
            ...
            <Box>
              ...
              <Text fontSize="lg" textAlign="justify" lineHeight="1.7">
                ...
                familiarization of masonry tools, test and measuring
                instruments. It also includes concrete mixture, work estimates,
                and form work.It moreover includes the study of metal
                reinforcements, plumbing and tile setting.
              </Text>
            </Box>
            <VStack spacing={12}>
              <Box w="full">
