        ...
        <VStack spacing={12}>
          <Box>
            ...
            <Text fontSize="lg" textAlign="justify" lineHeight="1.7">
              ...
              assist learning through game-based activities. Its main objective
              is to be a medium of fun learning in Civil Technology course.
              Game-based learning is a type of game play with defined learning
              outcomes (Shaffer, Halverson, Squire, & Gee, 2005). Game-based
              learning prompts the attention and the motivation of students to
              learn. The most frequently mentioned feature of games is their
              ability to motivate learners. The premise is that through a
              variety of motivational game features, games for enjoyment have
